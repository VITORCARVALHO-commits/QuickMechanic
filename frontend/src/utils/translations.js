export const translations = {
  pt: {
    ...
    nav: {
      ...
      services: 'Serviços',
      becomeMechanic: 'Seja um Mecânico',
      login: 'Entrar',
      dashboard: 'Painel',
      logout: 'Sair'
    },
    ...
    home: {
      ...
      quote: {
        title: 'Obtenha seu orçamento instantâneo',
      ...
      features: {
        ...
        feature4: {
          ...
          desc: 'Mecânico vai até você ou leva para oficina.'
        }
      },
      howItWorks: {
        title: 'Como funciona',
      ...
      stats: {
        mechanics: 'Mecânicos Verificados',
  ...
  en: {
    ...
    nav: {
      ...
      services: 'Services',
      becomeMechanic: 'Become a Mechanic',
      login: 'Login',
      dashboard: 'Dashboard',
      logout: 'Logout'
    },
    ...
    home: {
      ...
      features: {
        ...
        feature4: {
          ...
          desc: 'Mechanic comes to you or takes to workshop.'
        }
      },
      howItWorks: {
        title: 'How it works',
